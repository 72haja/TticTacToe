...
export default function PrivacyPolicy() {
  return (
    <main className="w-full h-full">
      <div className="bg-gray-500 text-white w-full h-full overflow-auto container mx-auto my-5">
        ...
        <ul>
          ...
          <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
              &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to T Tic Tac Toe.</p>
          </li>
          <li>
          ...
          <li>
            <p><strong>Website</strong> refers to T Tic Tac Toe, accessible from <a
                href="https://ttictactoe.onrender.com"
                rel="external nofollow noopener"
                target="_blank"
              >https://ttictactoe.onrender.com</a></p>
          </li>
          <li>
        ...
        <h2 className='text-3xl'>Collecting and Using Your Personal Data</h2>
        ...
        <p>Cookies can be &quot;Persistent&quot; or &quot;Session&quot; Cookies. Persistent Cookies remain
          ...
          as soon as You close Your web browser. Learn more about cookies on the <a
            href="https://www.privacypolicies.com/blog/privacy-policy-template/#Use_Of_Cookies_Log_Files_And_Tracking"
            target="_blank"
          >Privacy Policies website</a> article.</p>
        ...
        <h2 className='text-3xl'>Changes to this Privacy Policy</h2>
        ...
        <ul>
          <li>By email: t.tictactoe.2024@gmail.com</li>
        </ul>
      </div>
    </main>
  )
